...
// This file is taken and modified from the go-ethereum project
// The LICENSE file can be found at https://github.com/ethereum/go-ethereum/blob/master/COPYING
